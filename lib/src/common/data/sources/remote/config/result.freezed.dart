...
class __$$SuccessCopyWithImpl<T, $Res>
  ...
  __$$SuccessCopyWithImpl(this._value, this._then);

  final _$Success<T> _value;
  final $Res Function(_$Success<T>) _then;
...
class __$$FailureCopyWithImpl<T, $Res>
  ...
  __$$FailureCopyWithImpl(this._value, this._then);

  final _$Failure<T> _value;
  final $Res Function(_$Failure<T>) _then;
