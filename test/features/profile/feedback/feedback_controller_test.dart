    ...
    container =
        ProviderContainer(
            overrides: [
              ...
              feedbackCrashRecorderProvider.overrideWithValue(
                crashCapture.record,
              ),
            ],
          )
  ...
  group('FeedbackController.submit', () {
    ...
    test(
      ...
      () async {
        ...
        expect(fakeAnalytics.eventNames, isNot(contains('feedback_submitted')));
      },
    );
    ...
    test('updateMessage clears any prior errorMessage', () async {
      when(() => mockService.submit(any())).thenAnswer(
      ...
      expect(container.read(feedbackControllerProvider).errorMessage, isNull);
    });
  });
}
